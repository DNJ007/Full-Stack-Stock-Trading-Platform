    ...
    <div className='container mt-5'>
      <div className='row text-center'>
        ...
        <div className='col-4 p-3 mt-5 text-center '>
          <img src="media/images/smallcaseLogo.png" style={{height:"55px",width:"195px"}}/>
          <p className='text-small text-muted' >Thematic investing platform<br/>
that helps you invest in diversified<br/>
baskets of stocks on ETFs.</p>
        </div>
        <div className='col-4 p-3 mt-5'>
        <img src="media/images/zerodhaFundhouse.png" style={{height:"55px",width:"195px"}}/>
...
funds to help you save for your goals.
        ...
        <div className='col-4 p-3 mt-5'>
        <img src="media/images/sensibullLogo.svg"  style={{height:"55px",width:"195px"}}/>
...
data points like open interest, FII/DII, and more.</p>
        ...
        <div className='col-4 p-3 mt-5'>
        <img src="media/images/streakLogo.png"  style={{height:"55px",width:"195px"}}/>
          <p className='text-small text-muted'>Systematic trading platform<br/>
that allows you to create and backtest<br/>
strategies without coding.</p>
        </div>
        <div className='col-4 p-3 mt-5'>
        <img src="media/images/tijoriLogo.svg"  style={{height:"55px",width:"195px"}}/>
...
sectors, supply chains, and more.
        ...
        <div className='col-4 p-3 mt-5'>
        <img src="media/images/dittoLogo.png"  style={{height:"55px",width:"195px"}}/>
          <p className=' text-muted'>Personalized advice on life<br/>
