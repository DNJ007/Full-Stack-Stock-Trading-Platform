  ...
  return (
    ...
    <div className='container border-top mt-5'>
      <div className='row mt-5'>
        ...
        <div className='col'>
          <p className='mb-5 fs-5'>Company</p>
        ...
        <div className='col'>
          <p className='mb-5 fs-5'>Support</p>
        ...
        <div className='col'>
          <p className='mb-5 fs-5'>Account</p>
      ...
      <div className='row'>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>NSE</a></div>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>BSE</a></div>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>MCX</a></div>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>Terms & conditions</a></div>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>Policies & procedures</a></div>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>Privacy policy</a></div>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>Disclosure</a></div>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>For investor's attention</a></div>
      <div className='col-2 text-muted'><a href='' style={{textDecoration:"none",color:"gray"}}>Investor charter</a></div>
    </div>
    </div>
